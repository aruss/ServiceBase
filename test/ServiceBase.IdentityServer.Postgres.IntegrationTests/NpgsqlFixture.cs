    ...
    public class NpgsqlFixture : IDisposable
    {
        ...
        public void CreateDatabaseIfNotExists()
        {
            try
            {
                ...
                this.Connection.Execute(File.ReadAllText("./CreateDatabase.sql"));
            }
            catch (Exception)
            {
                // already exists 
            ...
            this.Connection.ExecuteFromFile("./CreateTables.sql");
        }
        ...
        {
            this.Connection.ExecuteFromFile("./ClearTables.sql");
        }
    }
}
