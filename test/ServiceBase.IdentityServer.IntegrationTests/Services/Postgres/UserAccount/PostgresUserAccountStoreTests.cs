...
namespace ServiceBase.IdentityServer.IntegrationTests
{
    ...
    public class PostgresUserAccountStoreTests : IDisposable
    {
        NpgsqlFixture db;

        public PostgresUserAccountStoreTests(NpgsqlFixture db)
        {
            this.db = db;
            this.db.CreateDatabaseIfNotExists();
            this.db.InsertData("./Services/Postgres/UserAccount/PostgresUserAccountStoreTests.sql");
        }
        ...
        [Theory]
        [JsonData("./Services/Postgres/UserAccount/PostgresUserAccountStoreTests_Default.json")]
        ...
        [Theory]
        [JsonData("./Services/Postgres/UserAccount/PostgresUserAccountStoreTests_LoadByEmailWithExternalAsync.json")]
        ...
        [Theory]
        [JsonData("./Services/Postgres/UserAccount/PostgresUserAccountStoreTests_LoadByExternalProviderAsync.json")]
        ...
        public void Foo()
        {
            ...
            File.WriteAllText("./Services/Postgres/user.json", JsonConvert.SerializeObject(user));
        }*/
    }
}
